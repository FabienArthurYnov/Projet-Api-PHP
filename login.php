...
function register()
{
	...
	if ($found) {
		...
		echo "Vous avez bien enregistré votre compte, pour se connecter veuillez aller dans la section connexion";
	}
}
				...
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						...
						<form action="#" method="post">
							...
							<button type="submit" class="btn btn-default" name="button1" class="button"
								value="Button1">Login</button>
						</form>
					</div><!--/login form-->
				</div>
				<div class="col-sm-1">
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						...
						<form action="#" method="post">
							...
							<input type="email" name="emailRegister" id="email" type="text" placeholder="Email Address">
							<input type="password" name="passwordRegister" id="password" type="text"
								placeholder="Password">
							<button type="submit" class="btn btn-default" name="button2" class="button"
								value="Button2">Signup</button>
						</form>
					</div><!--/sign up form-->
				</div>
			</div>
